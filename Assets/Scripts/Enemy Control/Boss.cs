...
public class Boss : Enemy
{
    ...
    //Purpose:          Controls the boss's health bar in the player UI
    {
    ...
    //Purpose:          Stops boss attacks and makes it vulnerable for a period of time
    {
    ...
    //Purpose:          Makes the boss charge in the player's direction until it hits a wall
    {
        lastPhase = true;
        animator.SetBool("lightAttack", false);
        animator.SetBool("heavyAttack", false);
    ...
    //=====OVERRIDING POLYMIORPHIC FUNCTION=====//
    ...
    //Purpose:          Checks whether the boss can see a wall
    {
    ...
    //Purpose:          Makes the boss light attack or heavy attack
    {
        attacking = true;
    ...
    //Purpose:          Finds the distance to the player and determine's the boss's behaviour
    {
    ...
    //Purpose:          Moves the boss in the direction of the player
    {
        animator.SetBool("lightAttack", false);
        animator.SetBool("heavyAttack", false);
